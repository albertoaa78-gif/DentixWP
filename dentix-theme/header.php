  ...
  <div class="search-block">
    ...
    <div class="search-hint" id="searchHint">
      ...
      <?php foreach (dentix_get_categories() as $cat) :
        // Enlazar directamente a la categoría de WooCommerce
        $cat_term = get_term_by('slug', $cat['slug'], 'product_cat');
        $cat_url  = $cat_term ? get_term_link($cat_term) : get_permalink(wc_get_page_id('shop'));
      ?>
