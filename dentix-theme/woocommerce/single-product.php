  ...
  <div class="pdp-gallery">
    <div class="pdp-main-img" id="pdpMainImg">
      <div class="pdp-badge-wrap">
        <?php if ($in_stock) : ?>
          <span class="pdp-badge pdp-badge-stock">
            <?php echo ($qty && $qty <= 5) ? 'Stock bajo &middot; ' . $qty . ' uds' : 'En stock'; ?>
          </span>
        <?php else : ?>
          <span class="pdp-badge pdp-badge-nostock">Sin stock</span>
        <?php endif; ?>
        <?php if ($on_sale) : ?>
          <span class="pdp-badge pdp-badge-sale">Oferta</span>
        <?php endif; ?>
      </div>
      <?php if ($main_img) : ?>
        <img id="pdpMainImgTag" src="<?php echo esc_url($main_img); ?>"
             alt="<?php echo esc_attr($product->get_name()); ?>"
             style="width:100%;height:100%;object-fit:contain;padding:20px;box-sizing:border-box">
      <?php else : ?>
